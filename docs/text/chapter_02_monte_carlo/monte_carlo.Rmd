...
Increase r to 100000. How much closer is the Monte Carlo estimate?
...
Did you ever learn the old school way to compute  $P(X>.426)$ using a Z-table?  If that's fun to recall, here is how you would do it.  If it gives you bad dreams, please skip ahead to "Two other things that we can investigate with Monte Carlo" because you don't need to know this anymore!  
