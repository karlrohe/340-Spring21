...
office: 1239 MSC  
[Syllabus](syllabus.pdf), [discussions](discussions), [text](text/worldDataModels.html),   [R labs](labs.R), and [Project description](projectDescription.html).
...
0) Questions for the exam?   
1) Maybe start [linear regression](http://pages.stat.wisc.edu/~karlrohe/ht/03-linear_regression.pdf) in ISLR.


Homework (due the week after exam), Chapter 3 in ISLR: Questions 1, 3, 4, and 15 (p120).   
